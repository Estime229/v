      ...
      <v-card tile class="mx-16 mt-n10 card1" color="white">
        <v-row>
          <v-col cols="12" sm="8" class="pr-0">
            <v-card height="250px" tile flat color="#00640080">
              <v-row>
                <v-col cols="12" sm="4" class="pl-8 pt-5">
                  <v-btn color="#00640080" dark class="withoutupercase" small tile>
                    new
                  </v-btn>
          ...
          <v-col cols="12" sm="3" class="mt-n6 pr-0">
            <v-toolbar flat outlined>
              ...
              <v-btn icon class="ml-1">
                <v-icon color="#228B22"> mdi-sync </v-icon>
              </v-btn>
            </v-toolbar>
          </v-col>
          ...
          <v-col cols="12" sm="3" class="mt-n6 pl-0">
            <v-toolbar flat outlined>
              <v-btn icon class="mr-1">
                <v-icon color="#00640080">mdi-apps</v-icon>
              </v-btn>
              <v-divider vertical></v-divider>
              ...
              <v-spacer></v-spacer>
              <v-badge color="#00640080" content="3" class="mr-2"></v-badge>
            </v-toolbar>
          </v-col>
